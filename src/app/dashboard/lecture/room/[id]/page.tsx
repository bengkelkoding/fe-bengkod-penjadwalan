...
const RoomDetail = () => {
  ...
  // data classRoom
  const [scheduleData, setScheduleData] = useState<DataLectureClass[] | undefined>();
  ...
  const selectedClass: DataLectureClass | undefined = scheduleData?.find((kelas: DataLectureClass) => kelas.id.toString() === id);
      ...
      <div className="head-info-room grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="box-1 flex items-center justify-center gap-8 p-3 bg-gradient-to-r from-[#3263de]  to-[#6aa2f0] rounded-lg shadow-md w-full h-[20vh]">
          <div className="icon  w-16 h-16 rounded-full flex justify-center items-center">
            <svg className="w-14 h-14 p-2 rounded-full bg-white/15  text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              <path
                fillRule="evenodd"
          ...
          <div className="text">
            <h1 className="text-5xl font-semibold text-white">{selectedClass.jumlah_mahasiswa}</h1>
        ...
        <div className="box-2 flex items-center justify-center gap-8  p-3 bg-gradient-to-r from-[#22733d]  to-[#3bc469] rounded-lg shadow-md w-full h-[20vh]">
          ...
          <div className="text">
            <h1 className="text-5xl font-semibold text-white">{dataSession?.length}</h1>
