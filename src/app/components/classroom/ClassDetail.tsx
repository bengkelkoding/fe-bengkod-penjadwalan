    ...
    <div className="px-4 bg-slate-300 w-full h-full sm:w-auto  md:w-1/2 lg:w-1/3 xl:w-1/4 mx-auto">
      <div className="">
        <div className="">
          ...
          <CardLecture
            ClassName={className}
            LectureName={classLecture}
            LectureNip={classNip}
            LecturePhone={classLecturePhone}
          />
          ...
          <div className="bg-white px-4 pt-2 pb-4 mt-8 rounded-3xl">
            ...
            <div className="flex justify-center px-2 mt-6 mb-2 ">
              <div className="">
                <p className="font-semibold text-blue-900 text-[13px] text-center ">
                  Hadir
                </p>
                <p className="font-semibold text-sm px-6 py-1 mt-1 text-center rounded-xl bg-green-400 text-white">
                  4
                </p>
              </div>
              ...
              <div className="mx-8">
                ...
                <p className="font-semibold text-sm px-6 py-1 mt-1 text-center rounded-xl bg-orange-400 text-white">
                  2
                </p>
              </div>
              ...
              <div className="">
                ...
                <p className="font-semibold text-sm px-6 py-1 mt-1 text-center rounded-xl bg-red-500 text-white">
                  3
                </p>
              </div>
            </div>
          ...
          <div className="flex justify-between  mt-4 bg-white rounded-2xl">
            ...
            <div className="font-semibold text-sm text-center rounded-xl   text-white ">
              <p className="bg-green-500 px-3 py-2  rounded-tr-xl rounded-bl-xl rounded-sm">
                Hadir
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-between  mt-4 bg-white rounded-2xl">
            ...
            <div className="font-semibold text-sm   text-center rounded-xl  text-white">
              <p className="bg-orange-500 px-3 py-2  rounded-tr-xl rounded-bl-xl  rounded-sm">
                Izin
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-between mt-4 bg-white rounded-2xl">
            ...
            <div className="font-semibold text-sm text-center rounded-xl text-white ">
              <p className="bg-red-500 px-3 py-2 rounded-tr-xl rounded-bl-xl rounded-sm">
                Absent
              </p>
            </div>
          </div>
